...
posts = [
    {'author': 'John Doe', 'title': 'First post', 'content': 'This is my first post!', 'date_posted': 'April 1, 2024', 'category': 'IT','email': 'john@example.com'},
    {'author': 'Jane Smith', 'title': 'Second post', 'content': 'Another day, another post.', 'date_posted': 'April 2, 2024', 'category': 'IT', 'email': 'jane@example.com'}
]
...
def add_post():
    if request.method == 'POST':
        ...
        new_post = {'author': author, 'title': title, 'content': content, 'date_posted': 'April 6, 2024', 'category': category, 'email': session['login_email']}  # Dummy date for demonstration
